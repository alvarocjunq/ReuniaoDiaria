...
TableTools.prototype = {
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		if ( oConfig.sInfo !== "" )
		{
			this.fnInfo( oConfig.sInfo, 4000 );
		}
...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Tabela copiada</h6>'+
				'<p>Copiado '+len+' registro'+plural+' para a &aacute;rea de transfer&ecirc;ncia.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Modo de impress&atilde;o</h6><p>Por favor, utilize a fun&ccedil;&atilde;o de impress&atilde;o "+
		  "do seu navegador para imprimir essa p&aacute;gina.<br>Pressione ESC para sair.",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "Modo Impress&atilde;o",
